    ...
    function acertou(obj) {
     ...
     function errou(obj) {
      ...
      const img = new Image(100);
      img.id = "imagem1";
      //altera o atributo src (source) da http://127.0.0.1:5500/smile/jogo.html imagem criada
      img.src = "https://static-00.iconduck.com/assets.00/cross-mark-emoji-512x512-9lmr75ja.png";
      //adiciona a imagem criada na div (obj) escolhida pelo jogador (appendChild)
      obj.appendChild(img);
    }
